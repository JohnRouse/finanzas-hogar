...
const CACHE_NAME = 'hogar-finanzas-v35-beta8-3-estados-plan-estables';
const APP_SHELL = [
  './index.html',
  './manifest.json',
  ...
  './css/etapa-18-beta8.css?v=35.0-beta.8.3',
  './js/experiencia-unificada-v32.js?v=35.0-beta.8.3',
