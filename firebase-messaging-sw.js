...
const CACHE_NAME = 'hogar-finanzas-v35-beta8-2-sincronizacion-estable';
const APP_SHELL = [
  './index.html',
  './manifest.json',
  ...
  './js/sincronizacion-financiera-ui.js?v=35.0-beta.8.2',
  ...
  './css/etapa-18-beta8.css?v=35.0-beta.8.2',
  './js/experiencia-unificada-v32.js?v=35.0-beta.8.2',
