...
const CACHE_NAME = 'hogar-finanzas-v34-identidad-navegacion-beta1';
const APP_SHELL = [
  './index.html',
  './manifest.json',
  ...
  './icons/icon-192.png',
  './icons/icon-512.png',
  './icons/app-icon.svg?v=34.0-beta.1',
  './icons/app-icon-maskable.svg?v=34.0-beta.1',
  ...
  './css/identidad-navegacion-v34.css?v=34.0-beta.1',
  './js/experiencia-unificada-v32.js?v=34.0-beta.1',
  ...
  './js/identidad-navegacion-v34.js?v=34.0-beta.1',
